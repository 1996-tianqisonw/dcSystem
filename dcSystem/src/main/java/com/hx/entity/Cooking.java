...
public class Cooking {
    ...
    private String kcCookingText;

    public String getKcCookingText() {
        return kcCookingText;
    }

    public void setKcCookingText(String kcCookingText) {
        this.kcCookingText = kcCookingText;
    }
