        ...
        <form name="" method="post" enctype="multipart/form-data">
            ...
            <div id="" class="easyui-tabs" style="width:800px;height:400px;">
                <div title="商品信息" style="padding:20px;">
                    商品名字：
                    <input id="goodsName" style="margin: 20px" class="easyui-validatebox"/>
                    商品标题：
                    <input id="goodsTitle" style="margin: 20px" class="easyui-validatebox"/><br>
                    商品编号：
                    <input id="goodsNo" style="margin: 20px" class="easyui-validatebox"/>
                    商品价格：
                    <input id="goodsPrice" style="margin: 20px" class="easyui-validatebox"/><br>
                    图片上传：<input id="goodsImg" style="margin: 20px" type="file"/>
                    商品状态：
                    <select id="goodsStatus" class="easyui-combobox" name="dept" style="width:100px;">
